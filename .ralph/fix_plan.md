...
- [ ] WI-026-feat 결재 상세 드로어 (요청상세, 4단계 결재 체인, 액션) | L1:Workflow > L2:상세 > L3:드로어 | batch:03
- [ ] WI-027-feat 워크플로우 빌더 (5단계 비주얼, 조건분기, CRUD) | L1:Workflow > L2:빌더 > L3:비주얼 | batch:04
...
- [ ] WI-034-feat Payroll DB 스키마 (PayrollRule, PayrollRun, Payslip + 6규칙 시드) | L1:Payroll > L2:DB > L3:급여모델 | batch:06
...
- [ ] WI-050-feat 리포트 센터 (7카드 그리드) | L1:Reports > L2:센터 > L3:그리드 | batch:15
